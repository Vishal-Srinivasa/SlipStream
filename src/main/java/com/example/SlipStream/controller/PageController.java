...
public class PageController {
    ...
    public ResponseEntity<String> createPage(@RequestBody Page page) {
        try {
            String pageId = pageService.createPage(page);
    ...
    public ResponseEntity<List<Page>> getChildPages(@PathVariable String parentPageId) {
        try {
            List<Page> childPages = pageService.getChildPages(parentPageId);
