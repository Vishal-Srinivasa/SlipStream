...
// /**
//  * Container page is a composite node in the composite pattern.
//  * It can contain other pages (both content and container pages).
//  */
// public class ContainerPage extends PageComponent {
//     private List<PageComponent> children;
//     private String summary; // Brief description or summary content
...
//         if (this.children != null) {
//             this.children.removeIf(child -> child.getPageId().equals(componentId));
//             this.lastUpdated = new Date();
//         }
//     }
